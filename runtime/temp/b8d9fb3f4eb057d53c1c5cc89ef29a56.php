<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:77:"D:\phpStudy\WWW\Thinkshop\public/../application/admin\view\category\edit.html";i:1516359076;s:67:"D:\phpStudy\WWW\Thinkshop\application\admin\view\public\header.html";i:1516262029;s:67:"D:\phpStudy\WWW\Thinkshop\application\admin\view\public\footer.html";i:1516262392;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<article class="page-container">
	<form action="<?php echo url('category/save'); ?>" method="post" class="form form-horizontal" id="form-member-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo $category['listorder']; ?>" placeholder="" id="listorder" name="listorder">
			</div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
				<select class="select" size="1" name="parent_id">
					...
					<?php if(is_array($categorys) || $categorys instanceof \think\Collection || $categorys instanceof \think\Paginator): $i = 0; $__LIST__ = $categorys;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
						<option <?php if($category['parent_id'] == $vo['id']): ?>selected="selected"<?php endif; ?> value="<?php echo $vo['id']; ?>">--<?php echo $vo['name']; ?></option>
